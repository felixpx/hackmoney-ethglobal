    ...
    <div className="m-2 flex w-11/12 flex-col justify-between rounded-xl bg-[#171717] p-8 px-16 text-base font-bold text-white shadow-lg lg:w-4/12">
      ...
      >
        <div className="flex w-6/12 flex-row items-center justify-evenly">
          ...
          <p className="whitespace-nowrap text-3xl font-bold">{title}</p>
        </div>
        {!isOpen ? (
      ...
      {isOpen && (
        <div className="flex flex-col items-center justify-evenly">
          <p className="mt-8 text-xs font-light text-gray-300">{description}</p>
          ...
          <div className="mt-6 flex w-full flex-row items-center justify-evenly">
            <div
              className="w-3/12 cursor-pointer rounded-full  bg-gradient-to-r from-[#5653E2] via-[#D77968] to-[#D86972] p-1.5 px-2 text-sm font-medium tracking-wide text-white"
